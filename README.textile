...
* The latest CakePHP 1.3 release. It's been in testing for the past 2 months, but untested with 1.2.x
...
<pre><code>
	...
	var $components = array('Sanction.Permit' => array('Auth.User'));

	// Example for default AuthsomeComponent Configuration
	var $components = array('Sanction.Permit' => array('User.User'));
</code></pre>
...
<pre><code>
	// Example for default AuthComponent Configuration
	var $helpers = array('Sanction.Clearance' => array('Auth.User'));

	// Example for default AuthsomeComponent Configuration
	var $helpers = array('Sanction.Clearance' => array('User.User'));
</code></pre>
