...
# Optionally set your path/check settings (below) - Permit::settings();
...
// optionally set your path/check here - these settings are avialable in the debug_kit panel
Permit::settings(array('path' => 'Auth', 'check' => 'User.id'));
